...
export default function NewTransactionPage() {
    ...
    const [description, setDescription] = useState(''); // Text summary
    const [content, setContent] = useState(''); // Rich text details
    const [attachments, setAttachments] = useState<Attachment[]>([]); // Multiple files
    ...
    const handleTypeChange = (newType: 'income' | 'expense') => {
        setType(newType);
        // Automatically select the first category of the new type
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const transactionData = {
                ...
                // Fallback amount for legacy schema support
            ...
            const res = await fetch('/api/admin/create', {
                ...
                body: JSON.stringify({ endpoint: 'transactions', content: transactionData }),
            });
    ...
    return (
        <div className={styles.formContainer}>
            <h1 className={styles.title}>取引の新規登録</h1>
